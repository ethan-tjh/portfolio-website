...
export default function ProjectDetail() {
    ...
    return (
        <main className="project-detail-page">
            ...
            {isImageEnlarged && (
                <div className="image-enlarge-modal" onClick={() => setIsImageEnlarged(false)}>
                    <button 
                        className="enlarge-close-btn" 
                        onClick={() => setIsImageEnlarged(false)}
                        aria-label="Close enlarged view"
                    >
                        ✕
                    </button>
                    <div className="enlarge-image-container" onClick={(e) => e.stopPropagation()}>
                        <img
                            src={images[currentImageIndex]}
                        ...
                        {images.length > 1 && (
                            <>
                                <button 
                                    ...
                                    className="enlarge-nav-btn enlarge-prev-btn"
                                    aria-label="Previous image"
                                >
                                    ‹
                                </button>
                                <button 
                                    ...
                                    className="enlarge-nav-btn enlarge-next-btn"
                                    aria-label="Next image"
                                >
                                    ›
                                </button>
                                <div className="enlarge-counter">
